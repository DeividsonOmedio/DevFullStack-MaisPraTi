...
function Atividade4(){
    /* Escreva um algoritmo para ler as notas das duas avaliações de um aluno no semestre, calcular e escrever a média semestral e 
    a seguinte mensagem: ‘PARABÉNS! Você foi aprovado’, somente se o aluno foi aprovado (considere 6.0 a nota mínima para aprovação). */
...
function Atividade11(){
    /* Escreva um algoritmo para ler uma quantidade indeterminada de valores inteiros. Para cada valor fornecido escrever uma mensagem que
    indica se cada valor fornecido é PAR ou ÍMPAR. O algoritmo será encerrado imediatamente após a leitura de um valor NULO ou NEGATIVO */
...
function Atividade12(){
    ...
    for(let numero = 1000; numero <= 1999; numero++) {
        if( numero % 11 === 5){
            console.log('O número: ' + numero + " é divisível por 11 com resto 5");
        }
    }
}
